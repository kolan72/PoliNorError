...
#pragma warning restore S3928 // Parameter names used into ArgumentException constructors should match an existing one 
		...
		[TestCase(true, false)]
		[TestCase(false, false)]
		public async Task Should_DefaultTypedErrorProcessor_Of_Action__Process_Only_Typed_Exception(bool errCanBeProcessed, bool isSync)
		{
			int i = 0;

			var processor = new DefaultTypedErrorProcessor<ArgumentException>((ex, _) => { if (ex.ParamName == "Test") i++; });
			Exception exToTest = null;
