...
In the opposite case, with non-generic handling, no generic delegate is called if only generic delegates are present. Instead, trivial functions are called, returning void or `Task`, possibly already obtained from counterpart.  
