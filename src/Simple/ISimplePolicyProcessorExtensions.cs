...
namespace PoliNorError
{
	internal static class ISimplePolicyProcessorExtensions
	{
		...
		public static ISimplePolicyProcessor ForError<TException>(this ISimplePolicyProcessor simplePolicyProcessor, Func<TException, bool> func = null) where TException : Exception => simplePolicyProcessor.ForError<ISimplePolicyProcessor, TException>(func);
