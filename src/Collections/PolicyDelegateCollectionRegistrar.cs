...
{
	/// <summary>
	/// Provides a set of extension methods to add policy, policy and a delegate, error filter or policy result handler to <see cref="IPolicyDelegateCollection"/> or <see cref="IPolicyDelegateCollection{T}"/>.
	/// </summary>
