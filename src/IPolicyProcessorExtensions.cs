...
namespace PoliNorError
{
	public static class IPolicyProcessorExtensions
	{
		...
		public static T ExcludeError<T, TException>(this T policyProcessor, Func<TException, bool> func = null) where T : IPolicyProcessor where TException : Exception
		{
		...
		{
			policyProcessor.AddIncludedErrorFilter(GetTypedErrorFilter(func));
		}
		...
		{
			policyProcessor.AddExcludedErrorFilter(GetTypedErrorFilter(func));
		}
