...
namespace PoliNorError
{
	public sealed partial class DefaultRetryProcessor
	{
		...
		{
			return RetryInternal(action, param, retryCountInfo, retryDelay, token);
		}
		...
		{
			return RetryInternalAsync(action, param, retryCountInfo, retryDelay, configureAwait, token);
		}
