...
namespace PoliNorError
{
	internal static class RetryPolicyErrorProcessorExtensions
	{
		...
		public static RetryPolicy ToRetryPolicy(this ErrorProcessorParam policyParams, int retryCount, RetryErrorSaver errorSaver, bool failedIfSaveErrorThrows = false)
		{
		...
		public static RetryPolicy ToRetryPolicyWithDelayProcessorOf(this ErrorProcessorParam policyParams, int retryCount, TimeSpan delay, RetryErrorSaver errorSaver, bool failedIfSaveErrorThrows = false)
		{
		...
		public static RetryPolicy ToRetryPolicyWithDelayProcessorOf(this ErrorProcessorParam policyParams, int retryCount, Func<int, Exception, TimeSpan> delayOnRetryFunc, RetryErrorSaver errorSaver, bool failedIfSaveErrorThrows = false)
		{
		...
		public static RetryPolicy ToInfiniteRetryPolicy(this ErrorProcessorParam policyParams, RetryErrorSaver errorSaver, bool failedIfSaveErrorThrows = false)
		{
		...
		public static RetryPolicy ToInfiniteRetryPolicyWithDelayProcessorOf(this ErrorProcessorParam policyParams, TimeSpan delay, RetryErrorSaver errorSaver, bool failedIfSaveErrorThrows = false)
		{
		...
		public static RetryPolicy ToInfiniteRetryPolicyWithDelayProcessorOf(this ErrorProcessorParam policyParams, Func<int, Exception, TimeSpan> delayOnRetryFunc, RetryErrorSaver errorSaver, bool failedIfSaveErrorThrows = false)
		{
